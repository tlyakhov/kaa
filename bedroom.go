...
func (r *bedroom) onEnter() {
	if r.state == "" {
		writeLn(color.HiBlackString("Tim is nowhere to be found. You see a shadow move out of the " +
			"corner of your eye. Maybe a trick of the light? You don't see it again."))
		r.state = "visited"
	} else {
	}
}
